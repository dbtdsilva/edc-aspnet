...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-condensed " DataSourceID="XmlDataSource1"
        ...
        <Columns>
            <asp:TemplateField HeaderText="Register Number" SortExpression="nregister">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("nregister") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="newNRegister" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Bind("nregister") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="XmlDataSource2" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Tax Number" SortExpression="taxnumber">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("taxnumber") %>'></asp:TextBox>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="newTaxNumber" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                </FooterTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("taxnumber") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Sold" SortExpression="sold">
                <EditItemTemplate>
                    <asp:Label ID="TextBox4" runat="server" ReadOnly="true" Text='<%# Bind("sold") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("sold") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
